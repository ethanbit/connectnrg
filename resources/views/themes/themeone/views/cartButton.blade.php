...
{{-- <a href="#" id="dropdownMenuButton" class="dropdown-toggle"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
	...
	<span class="block" style="display: none !important;">
...
<button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <span class="fa-stack fa-lg1">
    	<span class="badge badge-secondary">{{ $qunatity }}</span>
        <i class="fa fa-shopping-bag fa-stack-2x" aria-hidden="true"></i>
    </span>
</button>
...
<div class="shopping-cart dropdown-menu dropdown-menu-right" style="pointer-events:auto !important;" aria-labelledby="dropdownMenuButton">
	<ul class="shopping-cart-items" >
		<li>
			<div class="row">
				<div class="col-8"><b>Product</b></div>
		...
		<li>
			<div class="row">
				...
				<div class="col-4 quantity_price">
					<span class="item-quantity">{{$cart_data->customers_basket_quantity}}</span>
	...
	<div class="tt-summary">
		<div class="row">
			<div class="col-8">&nbsp;@lang('website.items')</div>
			<div class="col-4 text-center "><span>{{ $qunatity }}</span></div>
		</div>
