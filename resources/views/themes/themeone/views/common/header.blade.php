<header id="header-area" class="header-area bg-primary">
    ...
    <div class="header-maxi">
    	<div class="container">
        	<div class="row align-items-center">
            	<div class="col-12 col-sm-12 col-lg-4 spaceright-0">
...
-->
                            <li class="nav-item"> <a class="nav-link" href="{{ URL::to('/shop-online')}}">@lang('website.ShopOnline')</a> </li>
                           ...
                           <!--  <li class="nav-item dropdown mega-dropdown open">
                            ...
                            <li class="nav-item last">
															...
															<a class="nav-link"><span>@lang('website.hotline')</span>({{$result['commonContent']['setting'][11]->value}})</a></li> -->
                          </ul>
                        </div>
                    </nav>
                </div>
