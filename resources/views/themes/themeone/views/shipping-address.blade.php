                                    ...
                                    <table class="table table-hover">
                                      ...
                                      @foreach($result['address'] as $address_data)
                                        <tr>
                                          ...
                                          <td align="left">{{$address_data->firstname}} {{$address_data->lastname}}, {{$address_data->street}} {{$address_data->city}} {{$address_data->suburb}} {{$address_data->zone_name}} {{$address_data->postcode}}</td>
                        	...
                        	<div class="col-12">
                                    ...
                                    @endif
                                       ...
                                       @if(!empty($result['action']) and $result['action']=='update')
                                        ...
                                        <div class="form-group row">
                                            <label for="entry_company" class="col-sm-4 col-form-label">@lang('website.Company')</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            <label for="entry_phone" class="col-sm-4 col-form-label">Phone Number</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="entry_phone" class="form-control field-validate" id="entry_phone" @if(!empty($result['editAddress'])) value="{{$result['editAddress'][0]->phone}}" @endif>
                                                <span class="help-block error-content" hidden>@lang('website.Please enter your phone number')</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row" style="display:none">
                                            ...
                                            <div class="col-sm-8">
                                                <?php 
                                                // echo "<!-- Ducnb <pre>"; print_r($result); echo "</pre>".__FILE__.":".__LINE__.'-->';
                                                ?>
                                                <select name="entry_country_id" onChange="getZones();" id="entry_country_id" class="form-control field-validate">
													...
													$selected = '';
													if(!empty($result['editAddress'])){
    													if(empty($result['editAddress'][0]->countries_id)){
    													    $result['editAddress'][0]->countries_id = 13;
    													}
													}
													
													foreach($result['countries'] as $countries) {
														if(!empty($result['editAddress'])){
															if($countries->countries_id == $result['editAddress'][0]->countries_id){ 	
                                                                $selected = 'selected';
															}else{
                                                                $selected = '';
                                                            }
														}else{
															if($countries->countries_id == 13){
																$selected = 'selected';
															}else{
																$selected = '';
															}
                                                    ...
                                                    ?>
													<option value="{{$countries->countries_id}}" <?php echo $selected ?>>{{$countries->countries_name}}</option>
													<?php
                                                    }
													?>
                                                </select>
										...
										<div class="form-group row">
                                            <label for="entry_suburb" class="col-sm-4 col-form-label">Suburb</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="entry_suburb" class="form-control field-validate" id="entry_suburb" @if(!empty($result['editAddress'])) value="{{$result['editAddress'][0]->suburb}}" @endif>
                                                <span class="help-block error-content" hidden>@lang('website.Please enter your suburb')</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="entry_postcode" class="col-sm-4 col-form-label">Postcode</label>
                                            <div class="col-sm-8">
                                        ...
                                        $selected = '';
                                        if(!empty($result['editAddress'])){
                                          if($result['editAddress'][0]->default_address != ''){
                                            $selected = 'selected';
                                          }
                                        }else{
                                          $selected = 'selected';
                                        ...
                                        ?>
                                        <div class="form-group row">
                                            <label for="customers_default_address_id" class="col-sm-4 col-form-label">Default shipping address</label>
                                            <div class="col-sm-8">
                                                <select name="customers_default_address_id" id="customers_default_address_id" class="form-control field-validate">
