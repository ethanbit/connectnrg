                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/addNewConstantBanner', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Banner Title</label>
                                  <div class="col-sm-10 col-md-4">
                                      {!! Form::text('banners_title', '', array('class'=>'form-control','id'=>'banners_title')) !!}
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="type">
                                          ...
                                          <option value="8">Home Page Banner</option>
                                      </select>
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
