                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="type" id="bannerType">
                                          ...
                                          <option value="homepage" @if($result['sliders'][0]->type=='homepage') selected @endif>Home Page Desktop</option>
                                          <option value="mostliked" @if($result['sliders'][0]->type=='mostliked') selected @endif>{{ trans('labels.MostLiked') }}</option>
                                          <option value="homepagemobile" @if($result['sliders'][0]->type=='homepagemobile') selected @endif>Home Page Mobile</option>                                          
                                      </select>
                                       <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
