      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">			  
			<img  style="border-radius:0% !important; width:auto !important;" src="{{asset('').$web_setting[15]->value}}" class="user-image" alt="NRG Admin Logo">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
				...
				<img  style="border-radius:0% !important; width:auto !important;" src="{{asset('').$web_setting[15]->value}}" class="img-circle" alt="NRG Admin Logo">
