  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
		<img  style="max-width:75px !important;" src="{{asset('').$web_setting[15]->value}}" class="" alt="NRG Admin Logo">
      </div>
    ...
    @endif
      ...
      <li class="treeview {{ Request::is('admin/categories') ? 'active' : '' }} {{ Request::is('admin/addcategory') ? 'active' : '' }} {{ Request::is('admin/editCategory/*') ? 'active' : '' }} {{ Request::is('admin/subcategories') ? 'active' : '' }}  {{ Request::is('admin/addcategory') ? 'active' : '' }}  {{ Request::is('admin/editcategory/*') ? 'active' : '' }}">
        <a href="#">
     ...
     </li>	  <li class="treeview {{ Request::is('admin/subcategories') ? 'active' : '' }} {{ Request::is('admin/addsubcategory') ? 'active' : '' }} {{ Request::is('admin/editsubcategory/*') ? 'active' : '' }} {{ Request::is('admin/subcategories') ? 'active' : '' }}  {{ Request::is('admin/addsubcategory') ? 'active' : '' }}  {{ Request::is('admin/editsubcategory/*') ? 'active' : '' }}">        <a href="#">          <i class="fa fa-bars" aria-hidden="true"></i>          <span>{{ trans('labels.link_sub_categories') }} </span> <i class="fa fa-angle-left pull-right"></i>        </a>        <ul class="treeview-menu">         <li class="{{ Request::is('admin/subcategories') ? 'active' : '' }} {{ Request::is('admin/addsubcategory') ? 'active' : '' }} {{ Request::is('admin/editsubcategory/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/subcategories')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_sub_categories') }}</a></li>                </ul>     </li>
     @endif
     ...
     <li class="treeview {{ Request::is('admin/products') ? 'active' : '' }} {{ Request::is('admin/addproduct') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/attributes') ? 'active' : '' }}  {{ Request::is('admin/addattributes') ? 'active' : '' }} {{ Request::is('admin/addproductattribute/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} ">
      ...
      <ul class="treeview-menu">
        <li class="{{ Request::is('admin/products') ? 'active' : '' }} {{ Request::is('admin/addproduct') ? 'active' : '' }} {{ Request::is('admin/editproduct/*') ? 'active' : '' }} {{ Request::is('admin/addproductattribute/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/products')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_all_products') }}</a></li>
		 ...
		 <li class="{{ Request::is('admin/importproducts') ? 'active' : '' }}"><a href="{{ URL::to('admin/importproducts')}}"><i class="fa fa-circle-o"></i> Import Products</a></li>
...
<li class="treeview {{ Request::is('admin/sliders') ? 'active' : '' }} {{ Request::is('admin/addsliderimage') ? 'active' : '' }} {{ Request::is('admin/editslide/*') ? 'active' : '' }} {{ Request::is('admin/webpages') ? 'active' : '' }}  {{ Request::is('admin/addwebpage') ? 'active' : '' }}  {{ Request::is('admin/editwebpage/*') ? 'active' : '' }} {{ Request::is('admin/websettings') ? 'active' : '' }} {{ Request::is('admin/webthemes') ? 'active' : '' }} {{ Request::is('admin/customstyle') ? 'active' : '' }} {{ Request::is('admin/constantbanners') ? 'active' : '' }} {{ Request::is('admin/addconstantbanner') ? 'active' : '' }} {{ Request::is('admin/editconstantbanner/*') ? 'active' : '' }} {{ Request::is('admin/holiday') ? 'active' : '' }} {{ Request::is('admin/editholiday/*') ? 'active' : '' }} {{ Request::is('admin/addholiday') ? 'active' : '' }}  {{ Request::is('admin/groups') ? 'active' : '' }} " >
  <a href="#">
    <i class="fa fa-gears" aria-hidden="true"></i>
    <span> {{ trans('labels.link_site_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
  </a>
  <ul class="treeview-menu">
    <li class="{{ Request::is('admin/holiday') ? 'active' : '' }} {{ Request::is('admin/editholiday') ? 'active' : '' }} {{ Request::is('admin/addholiday/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/holiday')}}"><i class="fa fa-circle-o"></i> holiday</a></li>
    <li class="{{ Request::is('admin/groups') ? 'active' : '' }}"><a href="{{ URL::to('admin/groups')}}"><i class="fa fa-circle-o"></i> Groups</a></li>
