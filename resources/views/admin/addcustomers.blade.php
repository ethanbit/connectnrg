                         ...
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/addnewcustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('billing_firstname',  null, array('class'=>'form-control', 'id'=>'billing_firstname')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('billing_lastname',  null, array('class'=>'form-control', 'id'=>'billing_lastname')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('billing_street_address',  null, array('class'=>'form-control', 'id'=>'billing_street_address')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('billing_suburb',  null, array('class'=>'form-control', 'id'=>'billing_suburb')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('billing_postcode',  null, array('class'=>'form-control', 'id'=>'billing_postcode')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group d-none">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('billing_city',  null, array('class'=>'form-control', 'id'=>'billing_city')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {{-- {!! Form::text('billing_state',  null, array('class'=>'form-control', 'id'=>'billing_state')) !!} --}}
                                        <select class="form-control zoneContent" name="billing_state">    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('shipping_firstname',  null, array('class'=>'form-control', 'id'=>'shipping_firstname')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('shipping_lastname',  null, array('class'=>'form-control', 'id'=>'shipping_lastname')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('shipping_street_address',  null, array('class'=>'form-control', 'id'=>'shipping_street_address')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('shipping_suburb',  null, array('class'=>'form-control', 'id'=>'shipping_suburb')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('shipping_postcode',  null, array('class'=>'form-control', 'id'=>'shipping_postcode')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group d-none">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {!! Form::text('shipping_city',  null, array('class'=>'form-control', 'id'=>'shipping_city')) !!}
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        {{-- {!! Form::text('shipping_state',  null, array('class'=>'form-control', 'id'=>'shipping_state')) !!} --}}
                                        <select class="form-control zoneContent" name="shipping_state">    
                                            <option value="">{{ trans('labels.SelectState') }}</option>
                                        </select>
                                  </div>
                                </div>
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <?php 
                                        for($i = 0; $i < count($customers['groups']); $i++){
                                            $group = $customers['groups'][$i];
                                            $checked = false;
                                        ?>
                                        <div>
                                            <label>
