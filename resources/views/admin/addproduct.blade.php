                          ...
                          @endif
                            ...
                            {!! Form::open(array('url' =>'admin/addnewproduct', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}             
                                ...
                                <div class="form-group">
								  ...
								  <div class="form-group">
								    <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Distributors') }} </label>
                                      
                                      <div class="col-sm-10 col-md-4">
                                      <input readonly type="text" name="manufacturers_id" class="form-control field-validate" value="Spark Interact">   
                              ...
                              @endforeach
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-2">
                                    {!! Form::text('products_weight',  '0', array('class'=>'form-control number-validate_____1', 'id'=>'products_weight')) !!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('certification',  '', array('class'=>'form-control', 'id'=>'certification')) !!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::file('products_image', array('id'=>'products_image', 'class'=>'field-validate_____1')) !!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                ...
                                <div class="form-group">
								 ...
								 <!-- <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Unit Of measure</label>
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('unit_of_measure',  '', array('class'=>'form-control', 'id'=>'unit_of_measure')) !!}
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                    Please Add Unit OF Measure
                                    </span>
                                    <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                  </div>
                                </div> -->
                              ...
                              <div class="box-footer text-center">
                                ...
                                <button type="submit" class="btn btn-primary pull-right"  id="normal-btn" style="display: none"> Save </button>
