                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            </div>														<hr>                                                        <h4>Tax Information</h4>                            <hr>                                                        <div class="form-group">                              <label for="name" class="col-sm-2 col-md-3 control-label">Nb. tax amount is</label>                              <div class="col-sm-10 col-md-4">                                {!! Form::number($result['settings'][92]->name, $result['settings'][92]->value, array( 'min'=>'0', 'class'=>'form-control', 'id'=>$result['settings'][92]->name)) !!}<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">                                Please define the tax percent(%) on order total.</span>                              </div>                            </div>
