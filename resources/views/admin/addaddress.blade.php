        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <?php 
                $defaultAdd = '';
                if($data['defaultAdd'] == $customer_addresses->address_book_id){
                  $defaultAdd = 'default_address';
                }
              ?>
							<tr class="address {{$defaultAdd}}">
                    ...
                    <strong>{{ trans('labels.State') }}:</strong> {{ $customer_addresses->zone_name }}<br>
                    {{-- <strong>{{ trans('labels.Country') }}:</strong> {{ $customer_addresses->countries_name }} --}}
                    <strong>Phone number:</strong> {{ $customer_addresses->entry_phone }}<br>
                </td>
								<td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">	
              <div class="form-group">
               ...
               <div class="form-group">
                  <label for="entry_phone" class="col-sm-2 col-md-3 control-label">Phone number</label>
                  <div class="col-sm-10 col-md-8">
                    {!! Form::text('entry_phone',  '', array('class'=>'form-control', 'id'=>'entry_phone')) !!}
                  </div>
               </div>
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 col-md-8">
                      <select id="is_default" class="form-control" name="is_default">	
                          ...
                          <option value="1" selected>{{ trans('labels.Yes') }}</option>								 
                      </select>
                  </div>
                </div>
