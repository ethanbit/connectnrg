                        ...
                        @foreach ($result['devices'] as $key=>$device)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <strong>Device ID: </strong><span style="display:inline-block; width: 400px; overflow: hidden;"><i style="display:inline-block; width: 5000px;">{{ $device->device_id }}</i></span>
                                    <br>
                                ...
                                <td>
                                    @if($device->status==0)
                                        ...
                                        @else
                                            <a href="{{ URL::to("admin/devices")}}?id={{ $device->id}}&active=no" class="method-status">
                                              {{ trans('labels.InActive') }}
                                            </a>
                                        @endif
                                        &nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;
                                        ...
                                        @else
                                            <a href="{{ URL::to("admin/devices")}}?id={{ $device->id}}&active=yes" class="method-status">
                                               {{ trans('labels.Active') }} 
                                            </a>
                                        @endif                                  
                                </td>
