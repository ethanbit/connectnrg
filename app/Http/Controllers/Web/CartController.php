...
class CartController extends DataController
{
	...
	public function viewcart(Request $request){
		...
		$result['cart'] = $this->myCart($data);				$tax_rate_setting_data = DB::table('settings')->where('id',93)->get();		$tax_rate_setting= $tax_rate_setting_data[0]->value;		$result['tax_rate_setting'] = $tax_rate_setting;
		...
		}		//tax rate		$tax_rate_setting_data = DB::table('settings')->where('id',93)->get();		$tax_rate_setting= $tax_rate_setting_data[0]->value;		$result['tax_rate_setting'] = $tax_rate_setting;		 
		//dd(session('coupon'));
