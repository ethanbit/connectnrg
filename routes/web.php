...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		*/
			...
			Route::get('/holiday', 'AdminHolidayController@holiday');
			Route::get('/addholiday', 'AdminHolidayController@addholiday');
			Route::post('/deleteholiday', 'AdminHolidayController@deleteholiday');
			Route::post('/updateholiday', 'AdminHolidayController@updateholiday');
			Route::post('/addnewholiday', 'AdminHolidayController@addnewholiday');

			// groups
			Route::get('/groups', 'AdminGroupsController@groups');
			Route::get('/addgroup', 'AdminGroupsController@addgroup');
			Route::post('/deletegroup', 'AdminGroupsController@deletegroup');
			Route::post('/updategroup', 'AdminGroupsController@updategroup');
			Route::post('/addnewgroup', 'AdminGroupsController@addnewgroup');
			...
			//Distributers 
			Route::get('/adddistributers', 'AdminDistributerController@adddistributers');
            Route::post('/addnewdistributers', 'AdminDistributerController@addnewdistributers');
			//main categories
			...
			//import products
			Route::get('/importproducts', 'AdminProductsController@importproducts');
			Route::post('/importproductsdata', 'AdminProductsController@importproductsdata');
			...
			Route::post('/searchcustomers', 'AdminCustomersController@searchcustomers');
			...
			Route::post('/bulkupdateorders', 'AdminOrdersController@bulkUpdateOrders'); 	
			...
			Route::get('/deliverycalendar', 'AdminDeliveryDateController@deliverydatesetting');
		...
		Route::post('/addnewdelivery', 'AdminDeliveryDateController@addnewdelivery');
...
Route::group(['namespace' => 'Web'], function () {	
	...
	Route::get('/importcsv', 'DefaultController@importCSV');
	...
	*/
	...
	Route::get('/shop-online', 'ProductsController@shopcategories');
	// Route::get('/shop-online', function(){
	// 	return view('categories')->with('pageTitle', 'ngon');
	// });
	...
	*/
	...
	Route::get('/accountverification/{id}', 'CustomersController@accountverification');
	...
	*/
	...
	Route::group(['middleware' => 'Customer'], function () {						
		...
		Route::get('/order-thankyou/{id}', 'OrdersController@orderThankyou');		
		...
		Route::get('/mailtemplate', 'OrdersController@mailTemplate');	
		Route::post('/updatetheprice', 'OrdersController@updateThePrice');		
	});
});
